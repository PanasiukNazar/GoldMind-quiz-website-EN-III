const QUESTIONS = [
    {
        ...
        answers: ['Under 18', '18-29', '30-44', '45-59', '60 and above'],
    },
    {
        ...
        answers: [
            ...
            'I’ve been investing for many years',
        ],
    },
    {
        label: 'At what stage are you in your financial planning?',
        answers: [
            'Just starting out, laying the foundation',
            'Have some experience, working to grow further',
            'Established and focused on diversification and growth',
            'Nearing or in retirement, prioritizing security',
        ],
    },
    {
        label: 'How do you prefer to approach long-term wealth building?',
        answers: [
            'Aim for gradual growth with low risk',
            'Seek high returns even if it involves higher risk',
            'Maintain a balanced mix of risk and stability',
            'Focus on preserving wealth and minimizing risk',
        ],
    },
    {
        ...
        answers: [
            ...
            'Ensure long-term security for my family',
                        ...
                        .map(
                            (answer, index) =>
                                ...
                                <button class="answer col-md-12 col-lg-5 border rounded" data-action="selectAnswer" data-answer-index="${index}">
                                    <img class="answer-icon" src="img/answer-icon.png"> ${answer}
                                </button>
                            `,
                        )
                        .join('')}
